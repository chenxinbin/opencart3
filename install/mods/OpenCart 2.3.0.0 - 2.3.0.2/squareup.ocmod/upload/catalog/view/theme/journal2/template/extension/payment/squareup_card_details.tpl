...
<div id="squareup-notification">
    <div class="alert text-center information squareup_spacer_10"><i class="fa fa-circle-o-notch fa-spin"></i>&nbsp;<?php echo $text_loading; ?></div>
</div>
...
<script type="text/javascript">
    ...
    function squareupError(error) {
        ...
        $('#squareup-notification').html('<div class="alert warning text-danger squareup_spacer_10">' + error + '</div>');
    }
